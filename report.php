...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="navbar-header">
		...
		<h4 style="padding-left: 100px;padding-top: 20px;">BOOKSMART</h4>
	</div>
...
<div class="container-fluid">
  ...
  <div class="col-sm-8">
    <div class="row">
      <div class="col-xs-12">
        <h3 style="padding-left: 470px;color:maroon;font-family:cursive;font-style:italic">SALES REPORT GENERATION</h3><br>
...
<th>Sales</th>
                                ...
                                <?php
$ret=mysqli_query($conn,"select month(OrderDate) as lmonth,year(OrderDate) as lyear,
...
<h4 align="center" style="color:blue;margin-left:200px;font-family:monospace">Sales Report from <?php echo $y1;?> to <?php echo $y2;?></h4>
        <hr >
        <div class="row">
                            <table class="table table-bordered" width="100%"  border="0" style="padding-left:40px">
                                <thead>
...
<th>Sales</th>
                                ...
                                <?php
$ret=mysqli_query($conn,"select month(date) as lmonth,year(date) as lyear,
    books.book_price,order_items.Quantity from order_items
    join books on books.ID=orders.customerid 
    where date(orders.date) between '$fdate' and '$tdate'
    group by lyear ");
$num=mysqli_num_rows($ret);
if($num>0){
$cnt=1;
...
?>
              ...
              <td><?php  echo $total=$row['book_price']*$row['Quantity'];?></td>
